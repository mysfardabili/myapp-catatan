...
```bash
git remote add encore encore://personal-note-taking-app-hvd2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/personal-note-taking-app-hvd2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/personal-note-taking-app-hvd2/settings/integrations/github)
